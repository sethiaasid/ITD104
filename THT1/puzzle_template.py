...
def piece_a(x, y):
    top_cor = y + half_piece_size
    bottom_cor = y - half_piece_size
    left_cor = x - half_piece_size
    right_cor = x + half_piece_size

    # Draw tabs and blanks
    draw_tab(right_cor, y + gap_size, 'west')
    line(pos()[0], pos()[1], right_cor, bottom_cor)
    draw_tab(x - gap_size, bottom_cor, 'south')
    line(pos()[0], pos()[1], right_cor, bottom_cor)

    # Draw the outlines
    line(left_cor, bottom_cor, x - gap_size, bottom_cor)
    line(right_cor, top_cor, right_cor, y + gap_size)
    line(left_cor, top_cor, right_cor, top_cor)
    line(left_cor, top_cor, left_cor, bottom_cor)
