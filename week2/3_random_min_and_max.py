...
mi = limit_of_random_numbers + 1
ma = -1

for i in range(100):
	tmp = randint(1, limit_of_random_numbers)
	mi = min(mi, tmp)
	ma = max(ma, tmp)

print("Results for %d trials for random numbers between 1 and %d" 
	% (number_of_trials, limit_of_random_numbers))
print("The smallest number generated was %d" % (mi))
print("The largest number generated was %d" % (ma))
